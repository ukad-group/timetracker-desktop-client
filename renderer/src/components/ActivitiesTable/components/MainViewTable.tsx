...
const MainViewTable = () => {
  ...
  if (tableActivities.length === 0) return null;
        ...
        return (
          <tr
            ...
            className={clsx(`border-b border-gray-200 dark:border-gray-300 transition-transform `, {
              ...
              "scale-105 ":
                (firstKey && Number(firstKey) === i + 1 && !secondKey) ||
                (firstKey && secondKey && Number(firstKey + secondKey) === i + 1),
            })}
          >
            <td
            ...
            >
              ...
              <Tooltip
                tooltipText={(!validation.isValid && validation.cell === "time" && validation.description) || "Copied"}
